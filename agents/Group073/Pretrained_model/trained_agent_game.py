...
from trained_agent_noise import singh_maddala_onto_output, uniform_noise_onto_output
...
class MultiHexGame():
    ...
    def batched_single_move(self, model):        
        ...
        for idx in range(len(self.current_boards)):
            ...
            # print("Game.py: correct_position", correct_position)
            self.boards[self.current_boards[idx]].set_stone(correct_position)
        return outputs_tensor, correct_position
